...
import { GoDot } from 'react-icons/go'; // Change GoPrimitiveDot to GoDot
...
import LineChart from '../Component/Charts/LineCarts';
...
const Ecommerce = () => {
  ...
  style={{
    backgroundImage: `url("/images/download.png")`, // Adjust the path based on your setup
